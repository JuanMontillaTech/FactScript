...
/* Dashboard.html.twig */
class __TwigTemplate_c394210f243786afa109bc0584b6a0b8cd6598e9f0f4cd59015cebf8144d2123 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_sectionLowStock($__fsc__ = null, $__i18n__ = null, ...$__varargs__)
    {
        ...
        <div class=\"p-3\">
            ...
            // line 162
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "minimum-stock"], "method", false, false, false, 162), "html", null, true);
            echo "
            </h2>
        </div>
        <div class=\"table-responsive\">
            <table class=\"table table-sm table-hover mb-0\">
                ...
                <tr>
                    <th>";
            // line 169
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "reference"], "method", false, false, false, 169), "html", null, true);
            echo "</th>
                    <th>";
            // line 170
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "warehouse"], "method", false, false, false, 170), "html", null, true);
            echo "</th>
                    <th class=\"text-right\">";
            // line 171
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "minimum-stock"], "method", false, false, false, 171), "html", null, true);
            echo "</th>
                    <th class=\"text-right\">";
            // line 172
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "available"], "method", false, false, false, 172), "html", null, true);
            echo "</th>
                </tr>
                </thead>
                <tbody>
            ...
            // line 176
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "lowStock", [], "any", false, false, false, 176));
            foreach ($context['_seq'] as $context["_key"] => $context["stock"]) {
                // line 177
                echo "                    <tr class=\"clickableRow table-danger\" data-href=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stock"], "url", [], "method", false, false, false, 177), "html", null, true);
                echo "\">
                        <td>";
                // line 178
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stock"], "referencia", [], "any", false, false, false, 178), "html", null, true);
                echo "</td>
                        <td>";
                // line 179
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stock"], "codalmacen", [], "any", false, false, false, 179), "html", null, true);
                echo "</td>
                        <td class=\"text-right\">";
                // line 180
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 180), "numbers", [], "method", false, false, false, 180), "format", [0 => twig_get_attribute($this->env, $this->source, $context["stock"], "stockmin", [], "any", false, false, false, 180)], "method", false, false, false, 180), "html", null, true);
                echo "</td>
                        <td class=\"text-right\">";
                // line 181
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 181), "numbers", [], "method", false, false, false, 181), "format", [0 => twig_get_attribute($this->env, $this->source, $context["stock"], "disponible", [], "any", false, false, false, 181)], "method", false, false, false, 181), "html", null, true);
                echo "</td>
                    </tr>
                ";
            }
...
";
    ...
    ";
            // line 228
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "news", [], "any", false, false, false, 228));
    ...
    public function macro_sectionReceipts($__fsc__ = null, $__i18n__ = null, ...$__varargs__)
    {
        ...
        <div class=\"p-3\">
            ...
            // line 247
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "unpaid"], "method", false, false, false, 247), "html", null, true);
            echo "</span>
            <h2 class=\"h4 mb-0\">
                <i class=\"fas fa-dollar-sign fa-fw\"></i>
                ";
            // line 250
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "receipts"], "method", false, false, false, 250), "html", null, true);
            echo "
            </h2>
        </div>
        <div class=\"table-responsive\">
            <table class=\"table table-sm table-hover mb-0\">
                ...
                <tr>
                    <th>";
            // line 257
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "customer"], "method", false, false, false, 257), "html", null, true);
            echo "</th>
                    <th>";
            // line 258
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "observations"], "method", false, false, false, 258), "html", null, true);
            echo "</th>
                    <th class=\"text-right\">";
            // line 259
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "amount"], "method", false, false, false, 259), "html", null, true);
            echo "</th>
                    <th class=\"text-right\">";
            // line 260
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "expiration"], "method", false, false, false, 260), "html", null, true);
            echo "</th>
                </tr>
                </thead>
                <tbody>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["receipt"]) {
                ...
                // line 268
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "toolBox", [], "method", false, false, false, 268), "coins", [], "method", false, false, false, 268), "format", [0 => twig_get_attribute($this->env, $this->source, $context["receipt"], "importe", [], "any", false, false, false, 268)], "method", false, false, false, 268), "html", null, true);
                echo "</td>
                        <td class=\"text-right text-nowrap\">";
                // line 269
...
";
    ...
    public function macro_sectionStats($__fsc__ = null, $__i18n__ = null, ...$__varargs__)
    {
        ...
        <div class=\"col-sm-6 col-lg-3\">
            ";
            // line 281
            echo twig_call_macro($macros["_self"], "macro_drawStatsBox", [($context["fsc"] ?? null), ($context["i18n"] ?? null), "purchases", "bg-danger", true], 281, $context, $this->getSourceContext());
            echo "
        </div>
        <div class=\"col-sm-6 col-lg-3\">
            ";
            // line 284
            echo twig_call_macro($macros["_self"], "macro_drawStatsBox", [($context["fsc"] ?? null), ($context["i18n"] ?? null), "sales", "bg-success", true], 284, $context, $this->getSourceContext());
            echo "
        </div>
        <div class=\"col-sm-6 col-lg-3\">
            ";
            // line 287
            echo twig_call_macro($macros["_self"], "macro_drawStatsBox", [($context["fsc"] ?? null), ($context["i18n"] ?? null), "taxes", "bg-warning", true], 287, $context, $this->getSourceContext());
            echo "
        </div>
        <div class=\"col-sm-6 col-lg-3\">
            ";
            // line 290
            echo twig_call_macro($macros["_self"], "macro_drawStatsBox", [($context["fsc"] ?? null), ($context["i18n"] ?? null), "new-customers", "bg-info", false], 290, $context, $this->getSourceContext());
            echo "
        </div>
    </div>
";
    ...
    {
        return array (  704 => 290,  698 => 287,  692 => 284,  686 => 281,  682 => 279,  668 => 278,  655 => 272,  646 => 269,  642 => 268,  638 => 267,  634 => 266,  629 => 265,  625 => 264,  618 => 260,  614 => 259,  610 => 258,  606 => 257,  596 => 250,  590 => 247,  586 => 245,  572 => 244,  553 => 236,  549 => 235,  543 => 234,  536 => 229,  532 => 228,  493 => 191,  479 => 190,  466 => 184,  457 => 181,  453 => 180,  449 => 179,  445 => 178,  440 => 177,  436 => 176,  429 => 172,  425 => 171,  421 => 170,  417 => 169,  407 => 162,  402 => 159,  388 => 158,  355 => 133,  351 => 131,  346 => 128,  337 => 125,  331 => 124,  327 => 123,  324 => 122,  320 => 121,  314 => 118,  310 => 116,  308 => 115,  304 => 113,  293 => 110,  290 => 109,  286 => 108,  280 => 105,  273 => 100,  259 => 99,  247 => 94,  240 => 92,  234 => 90,  226 => 88,  223 => 87,  221 => 86,  217 => 85,  214 => 84,  210 => 83,  202 => 78,  197 => 76,  194 => 75,  177 => 74,  171 => 69,  167 => 67,  161 => 65,  158 => 64,  152 => 62,  150 => 61,  146 => 59,  142 => 58,  135 => 56,  131 => 55,  123 => 51,  119 => 49,  115 => 48,  110 => 71,  107 => 58,  104 => 55,  102 => 48,  91 => 41,  84 => 37,  80 => 36,  77 => 35,  70 => 31,  66 => 30,  63 => 29,  61 => 28,  54 => 23,  50 => 22,  39 => 20,);
    }
